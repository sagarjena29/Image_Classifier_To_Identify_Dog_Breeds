    ...
    if (print_incorrect_dogs and
        ...
        for key in results_dic:
            ...
            if sum(results_dic[key][3:]) == 1:
                print('pet label :' + results_dic[key][0] + ' and classifier label :' + results_dic[key][1])

    # IF print_incorrect_breed == True AND there were dogs whose breeds
    # were incorrectly classified - print out these casess
    if (print_incorrect_breed and
        ...
        for key in results_dic:
            ...
            if (sum(results_dic[key][3:]) == 2 and
                    results_dic[key][2] == 0):
                print("Real: {:>26}   Cl"
                      "assifier: {:>30}".format(results_dic[key][0],
                                                                 results_dic[key][1]))
